      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[32px] bg-navy-900 text-white shadow-[0_24px_70px_rgba(10,17,56,0.2)]">
        <div className="grid lg:grid-cols-[1.35fr_0.65fr]">
          <div className="p-7 md:p-10 lg:p-14">
            <span className="text-xs font-bold text-accent-400">بخون و ببخش</span>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-8 text-navy-200 md:text-base">کتاب‌هایت را برای اهدا ثبت کن تا دانش‌آموز بعدی بتواند بدون هزینه مسیرش را ادامه بدهد.</p>

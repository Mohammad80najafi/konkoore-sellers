  ...
  return (
    <section className="relative overflow-hidden gradient-hero text-white">
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        {/* Floating book icons */}
        <div className="absolute top-20 right-[15%] text-4xl opacity-10 animate-float">📚</div>
        <div className="absolute top-32 left-[20%] text-3xl opacity-10 animate-float" style={{ animationDelay: "1s" }}>📖</div>
        <div className="absolute bottom-20 right-[30%] text-3xl opacity-10 animate-float" style={{ animationDelay: "2s" }}>🎓</div>
        <div className="absolute bottom-32 left-[10%] text-4xl opacity-10 animate-float" style={{ animationDelay: "0.5s" }}>✏️</div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 lg:py-32">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6 animate-fade-in text-balance">
            کتابهای کنکورت رو{" "}
            <span className="text-accent-400">ارزونتر</span> بخر،{" "}
            <span className="text-accent-400">راحتتر</span> بفروش
          </h1>
          ...
          {/* Quick stats */}
          <div className="mt-12 flex items-center justify-center gap-8 md:gap-12 text-sm text-navy-200 animate-fade-in" style={{ animationDelay: "0.6s" }}>

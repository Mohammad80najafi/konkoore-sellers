...
const footerLinks = {
  ...
  sellers: {
    title: "اهداکنندگان",
    links: [
      { href: "/create-listing", label: "اهدای کتاب" },
      { href: "/dashboard", label: "داشبورد من" },
      { href: "/faq", label: "راهنمای اهدا" },
    ],
  },
  support: {
    title: "پشتیبانی",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-navy-200 leading-relaxed mb-4">
              سامانه اهدای رایگان کتاب‌های دست دوم کنکور. بخون و ببخش؛ یک کتاب را به مسیر دانش‌آموز بعدی برسان.
            </p>

...
export const metadata = {
  title: "درباره ما",
  description:
    "با کنکورباز آشنا شوید — سامانه اهدای رایگان کتاب‌های دست دوم کنکور",
};

const stats = [
  { value: "۲۵,۰۰۰+", label: "کاربر فعال" },
  { value: "۱۲,۵۰۰+", label: "کتاب اهدا شده" },
  { value: "۹,۸۰۰+", label: "اهدای موفق" },
...
const values = [
  {
    ...
    description:
      "گفت‌وگو و هماهنگی مستقیم کمک می‌کند کتاب با اطمینان به دست دانش‌آموز بعدی برسد.",
  },
  {
    icon: "🎁",
    title: "اهدای بی‌واسطه",
    description:
      "بدون واسطه و بدون هزینه، مستقیم با اهداکننده هماهنگ شوید و کتاب را تحویل بگیرید.",
  },
  {
    icon: "🌍",
    title: "محیط زیست",
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="text-surface-600 space-y-4 leading-relaxed">
              <p>
                ...
                سال روی کتابخانه خاک بخورند، در حالی که دانش‌آموزان سال بعد به
                همان کتاب‌ها نیاز دارند؟
              </p>
              <p>
                ما یک پلتفرم ساختیم که اهدای کتاب‌های دست دوم کنکور را
                آسان و مستقیم می‌کند. بدون واسطه و بدون هزینه — از یک
                دانش‌آموز به دانش‌آموز دیگر.
              </p>
              <p>
        ...
        <div className="gradient-hero relative overflow-hidden rounded-3xl p-8 text-center text-white md:p-12">
          ...
          <div className="relative z-10">
            ...
            <p className="text-navy-200 mx-auto mb-6 max-w-lg">
              همین حالا کتاب‌های کنکورتان را ببخشید یا یک کتاب اهدایی برای
              ادامه مسیرتان پیدا کنید.
            </p>
